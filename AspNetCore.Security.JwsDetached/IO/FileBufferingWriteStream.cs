...
namespace AspNetCore.Security.JwsDetached.IO
{
    ...
    public sealed class FileBufferingWriteStream : System.IO.Stream
    {
        ...
        /// uses the value returned by <see cref="System.IO.Path.GetTempPath"/>.
        /// </param>
        ...
        public async Task DrainBufferAsync(System.IO.Stream destination, CancellationToken cancellationToken = default)
        {
